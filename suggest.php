      ...
      <table>
        ...
        <tr>
          ...
          <td><select id="category" name="category">
            ...
            <option value="Music"<?php if (isset($category) && $category == "Music") { echo " selected"; } ?>>Music</option></select>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <th><label for="name">Additional Item Details </label></th>
          <td><textarea name="details" id="details"><?php if (isset($details)) { echo htmlspecialchars($details); }?></textarea></td>
        </tr>
        <tr style="display:none">
          <th><label for="address">Address </label></th>
          <td><input type="text" id="email" name="address"/><p>Please leave this field blank</p></td>
        </tr>
      </table>
